...
export async function POST(request: NextRequest) {
  try {
    ...
    const new_car: Car = {
      ...
      is_width_pass: false,
      is_ground_clearance_pass: false,
      is_no_loose_parts: false,
      is_flat_region_front: false,
      is_axles_precut_slots: false,
      is_axles_wheels_bsa: false,
      is_wheel_diameter_pass: false,
      is_dry_powder_lubricant: false,
      is_no_propulsion: false,
      is_no_magnets_glue_front: false,
      runs: [],
      beauty_scores: [],
    };
